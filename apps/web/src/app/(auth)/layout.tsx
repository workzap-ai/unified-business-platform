      ...
      <aside className="relative hidden overflow-hidden bg-sidebar p-10 text-sidebar-foreground lg:flex lg:flex-col">
        ...
        <div className="my-auto max-w-lg">
          ...
          <h2 className="mt-4 text-3xl leading-tight font-semibold tracking-tight">
            Customers, catalog, orders and money in one place, with an AI assistant that works
            from your real data.
          </h2>
          <ul className="mt-10 space-y-5 text-sm">
            <li className="flex gap-3">
              <Bot className="mt-0.5 size-5 shrink-0 text-pi" aria-hidden="true" />
              <span>
                <span className="font-semibold">PI answers on WhatsApp</span>
                <span className="block text-sidebar-muted">
                  Checks real stock and prices, drafts orders, and hands off to your team when a
                  person should decide.
                </span>
              </span>
            </li>
            <li className="flex gap-3">
              <Sparkles className="mt-0.5 size-5 shrink-0 text-sidebar-muted" aria-hidden="true" />
              <span>
                <span className="font-semibold">Every module connected</span>
                <span className="block text-sidebar-muted">
                  A confirmed order moves stock, issues the invoice and shows up on the customer.
                </span>
              </span>
            </li>
            <li className="flex gap-3">
              <ShieldCheck className="mt-0.5 size-5 shrink-0 text-sidebar-muted" aria-hidden="true" />
              <span>
                <span className="font-semibold">Isolated by design</span>
                <span className="block text-sidebar-muted">
                  Each workspace and environment is separated, and every action is permission
                  checked and audited.
                </span>
              </span>
            </li>
        ...
        <p className="text-xs text-sidebar-muted">Secure session · HttpOnly cookies · CSRF protected</p>
      </aside>
